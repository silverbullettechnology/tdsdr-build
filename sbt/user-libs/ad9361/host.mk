# Host Makefile AD9361 userspace driver, library, and tool
#
...
export CONFIG_USER_LIBS_AD9361_INCLUDES := y
export CONFIG_USER_LIBS_AD9361_STATIC   := y
export CONFIG_USER_LIBS_AD9361_READLINE := y
