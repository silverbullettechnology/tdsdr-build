 ...
 */
#ifndef _INCLUDE_APP_AD9361_MAP_H_
#define _INCLUDE_APP_AD9361_MAP_H_
...
struct ad9361_map_cmd_t
{
	const char       *arg0;
	const char       *name;
	ad9361_handler_f  func;
	int               argc;
};


struct ad9361_map_arg_t
{
	const char *func;
	int         idx;
	const char *name;
...
#define MAP_CMD(arg0,func,argc) \
	static struct ad9361_map_cmd_t ad9361_map_cmd_ ## arg0 \
	 __attribute__((unused,used,section("ad9361_map_cmd"),aligned(sizeof(void *)))) \
	 = { #arg0, #func, func, argc }
