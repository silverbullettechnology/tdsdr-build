...
{
	return get_int(dev, "bist_prbs", mode);
}
int ad9361_set_bist_prbs (unsigned dev, int  mode)
{
	return set_int(dev, "bist_prbs", mode);
}
...
{
	return get_int(dev, "bist_tone", mode);
}
int ad9361_set_bist_tone (unsigned dev, int  mode, uint32_t freq_Hz,
                          uint32_t level_dB, uint32_t mask)
{
	return ad9361_sysfs_printf(dev, ROOT, "bist_tone", "%d %u %u %u\n",
	                           mode, freq_Hz, level_dB, mask);
}
                            ...
                            uint32_t *tia_index,    uint32_t *mixer_index)
{
	...
	char leaf[32];
	snprintf(leaf, sizeof(leaf), "gaininfo_rx%d", channel);

	int ret = ad9361_sysfs_scanf(dev, ROOT, leaf, "%d %u %u %u %u %u %u %u",
...
{
	return set_int(dev, "initialize", 1);
}
...
{
	return get_int(dev, "loopback", mode);
}
int ad9361_set_loopback (unsigned dev, int  mode)
{
	return set_int(dev, "loopback", mode);
}
...
{
	return get_int(dev, "adi,frequency-division-duplex-mode-enable", val);
}
int ad9361_set_frequency_division_duplex_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,frequency-division-duplex-mode-enable", val);
}
...
{
	return get_int(dev, "adi,ensm-enable-pin-pulse-mode-enable", val);
}
int ad9361_set_ensm_enable_pin_pulse_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,ensm-enable-pin-pulse-mode-enable", val);
}
...
{
	return get_int(dev, "adi,ensm-enable-txnrx-control-enable", val);
}
int ad9361_set_ensm_enable_txnrx_control_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,ensm-enable-txnrx-control-enable", val);
}
...
{
	return get_int(dev, "adi,debug-mode-enable", val);
}
int ad9361_set_debug_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,debug-mode-enable", val);
}
...
{
	return get_int(dev, "adi,tdd-use-fdd-vco-tables-enable", val);
}
int ad9361_set_tdd_use_fdd_vco_tables_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,tdd-use-fdd-vco-tables-enable", val);
}
...
{
	return get_int(dev, "adi,tdd-use-dual-synth-mode-enable", val);
}
int ad9361_set_tdd_use_dual_synth_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,tdd-use-dual-synth-mode-enable", val);
}
...
{
	return get_int(dev, "adi,tdd-skip-vco-cal-enable", val);
}
int ad9361_set_tdd_skip_vco_cal_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,tdd-skip-vco-cal-enable", val);
}
...
{
	return get_int(dev, "adi,2rx-2tx-mode-enable", val);
}
int ad9361_set_2rx_2tx_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,2rx-2tx-mode-enable", val);
}
...
{
	return get_int(dev, "adi,split-gain-table-mode-enable", val);
}
int ad9361_set_split_gain_table_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,split-gain-table-mode-enable", val);
}
...
{
	return get_u32(dev, "adi,rx-rf-port-input-select", val);
}
int ad9361_set_rx_rf_port_input_select (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rx-rf-port-input-select", val);
}
...
{
	return get_u32(dev, "adi,tx-rf-port-input-select", val);
}
int ad9361_set_tx_rf_port_input_select (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,tx-rf-port-input-select", val);
}
...
{
	return get_int(dev, "adi,external-tx-lo-enable", val);
}
int ad9361_set_external_tx_lo_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,external-tx-lo-enable", val);
}
...
{
	return get_int(dev, "adi,external-rx-lo-enable", val);
}
int ad9361_set_external_rx_lo_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,external-rx-lo-enable", val);
}
...
{
	return get_int(dev, "adi,xo-disable-use-ext-refclk-enable", val);
}
int ad9361_set_xo_disable_use_ext_refclk_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,xo-disable-use-ext-refclk-enable", val);
}
...
{
	return get_u32(dev, "adi,clk-output-mode-select", val);
}
int ad9361_set_clk_output_mode_select (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,clk-output-mode-select", val);
}
...
{
	return get_u32(dev, "adi,dc-offset-tracking-update-event-mask", val);
}
int ad9361_set_dc_offset_tracking_update_event_mask (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,dc-offset-tracking-update-event-mask", val);
}
...
{
	return get_u32(dev, "adi,dc-offset-attenuation-high-range", val);
}
int ad9361_set_dc_offset_attenuation_high_range (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,dc-offset-attenuation-high-range", val);
}
...
{
	return get_u32(dev, "adi,dc-offset-attenuation-low-range", val);
}
int ad9361_set_dc_offset_attenuation_low_range (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,dc-offset-attenuation-low-range", val);
}
...
{
	return get_u32(dev, "adi,dc-offset-count-high-range", val);
}
int ad9361_set_dc_offset_count_high_range (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,dc-offset-count-high-range", val);
}
...
{
	return get_u32(dev, "adi,dc-offset-count-low-range", val);
}
int ad9361_set_dc_offset_count_low_range (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,dc-offset-count-low-range", val);
}
...
{
	return get_u32(dev, "adi,rf-rx-bandwidth-hz", val);
}
int ad9361_set_rf_rx_bandwidth_hz (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rf-rx-bandwidth-hz", val);
}
...
{
	return get_u32(dev, "adi,rf-tx-bandwidth-hz", val);
}
int ad9361_set_rf_tx_bandwidth_hz (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rf-tx-bandwidth-hz", val);
}
...
{
	return get_u32(dev, "adi,tx-attenuation-mdB", val);
}
int ad9361_set_tx_attenuation_mdB (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,tx-attenuation-mdB", val);
}
...
{
	return get_int(dev, "adi,update-tx-gain-in-alert-enable", val);
}
int ad9361_set_update_tx_gain_in_alert_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,update-tx-gain-in-alert-enable", val);
}
...
{
	return get_u32(dev, "adi,gc-rx1-mode", val);
}
int ad9361_set_gc_rx1_mode (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-rx1-mode", val);
}
...
{
	return get_u32(dev, "adi,gc-rx2-mode", val);
}
int ad9361_set_gc_rx2_mode (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-rx2-mode", val);
}
...
{
	return get_u32(dev, "adi,gc-adc-ovr-sample-size", val);
}
int ad9361_set_gc_adc_ovr_sample_size (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-adc-ovr-sample-size", val);
}
...
{
	return get_u32(dev, "adi,gc-adc-small-overload-thresh", val);
}
int ad9361_set_gc_adc_small_overload_thresh (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-adc-small-overload-thresh", val);
}
...
{
	return get_u32(dev, "adi,gc-adc-large-overload-thresh", val);
}
int ad9361_set_gc_adc_large_overload_thresh (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-adc-large-overload-thresh", val);
}
...
{
	return get_u32(dev, "adi,gc-lmt-overload-high-thresh", val);
}
int ad9361_set_gc_lmt_overload_high_thresh (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-lmt-overload-high-thresh", val);
}
...
{
	return get_u32(dev, "adi,gc-lmt-overload-low-thresh", val);
}
int ad9361_set_gc_lmt_overload_low_thresh (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-lmt-overload-low-thresh", val);
}
...
{
	return get_u32(dev, "adi,gc-dec-pow-measurement-duration", val);
}
int ad9361_set_gc_dec_pow_measurement_duration (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-dec-pow-measurement-duration", val);
}
...
{
	return get_u32(dev, "adi,gc-low-power-thresh", val);
}
int ad9361_set_gc_low_power_thresh (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-low-power-thresh", val);
}
...
{
	return get_int(dev, "adi,gc-dig-gain-enable", val);
}
int ad9361_set_gc_dig_gain_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,gc-dig-gain-enable", val);
}
...
{
	return get_u32(dev, "adi,gc-max-dig-gain", val);
}
int ad9361_set_gc_max_dig_gain (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,gc-max-dig-gain", val);
}
...
{
	return get_int(dev, "adi,mgc-rx1-ctrl-inp-enable", val);
}
int ad9361_set_mgc_rx1_ctrl_inp_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,mgc-rx1-ctrl-inp-enable", val);
}
...
{
	return get_int(dev, "adi,mgc-rx2-ctrl-inp-enable", val);
}
int ad9361_set_mgc_rx2_ctrl_inp_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,mgc-rx2-ctrl-inp-enable", val);
}
...
{
	return get_u32(dev, "adi,mgc-inc-gain-step", val);
}
int ad9361_set_mgc_inc_gain_step (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,mgc-inc-gain-step", val);
}
...
{
	return get_u32(dev, "adi,mgc-dec-gain-step", val);
}
int ad9361_set_mgc_dec_gain_step (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,mgc-dec-gain-step", val);
}
...
{
	return get_u32(dev, "adi,mgc-split-table-ctrl-inp-gain-mode", val);
}
int ad9361_set_mgc_split_table_ctrl_inp_gain_mode (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,mgc-split-table-ctrl-inp-gain-mode", val);
}
...
{
	return get_u32(dev, "adi,agc-attack-delay-extra-margin-us", val);
}
int ad9361_set_agc_attack_delay_extra_margin_us (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-attack-delay-extra-margin-us", val);
}
...
{
	return get_u32(dev, "adi,agc-outer-thresh-high", val);
}
int ad9361_set_agc_outer_thresh_high (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-outer-thresh-high", val);
}
...
{
	return get_u32(dev, "adi,agc-outer-thresh-high-dec-steps", val);
}
int ad9361_set_agc_outer_thresh_high_dec_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-outer-thresh-high-dec-steps", val);
}
...
{
	return get_u32(dev, "adi,agc-inner-thresh-high", val);
}
int ad9361_set_agc_inner_thresh_high (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-inner-thresh-high", val);
}
...
{
	return get_u32(dev, "adi,agc-inner-thresh-high-dec-steps", val);
}
int ad9361_set_agc_inner_thresh_high_dec_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-inner-thresh-high-dec-steps", val);
}
...
{
	return get_u32(dev, "adi,agc-inner-thresh-low", val);
}
int ad9361_set_agc_inner_thresh_low (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-inner-thresh-low", val);
}
...
{
	return get_u32(dev, "adi,agc-inner-thresh-low-inc-steps", val);
}
int ad9361_set_agc_inner_thresh_low_inc_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-inner-thresh-low-inc-steps", val);
}
...
{
	return get_u32(dev, "adi,agc-outer-thresh-low", val);
}
int ad9361_set_agc_outer_thresh_low (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-outer-thresh-low", val);
}
...
{
	return get_u32(dev, "adi,agc-outer-thresh-low-inc-steps", val);
}
int ad9361_set_agc_outer_thresh_low_inc_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-outer-thresh-low-inc-steps", val);
}
...
{
	return get_u32(dev, "adi,agc-adc-small-overload-exceed-counter", val);
}
int ad9361_set_agc_adc_small_overload_exceed_counter (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-adc-small-overload-exceed-counter", val);
}
...
{
	return get_u32(dev, "adi,agc-adc-large-overload-exceed-counter", val);
}
int ad9361_set_agc_adc_large_overload_exceed_counter (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-adc-large-overload-exceed-counter", val);
}
...
{
	return get_u32(dev, "adi,agc-adc-large-overload-inc-steps", val);
}
int ad9361_set_agc_adc_large_overload_inc_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-adc-large-overload-inc-steps", val);
}
...
{
	return get_int(dev, "adi,agc-adc-lmt-small-overload-prevent-gain-inc-enable", val);
}
int ad9361_set_agc_adc_lmt_small_overload_prevent_gain_inc_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,agc-adc-lmt-small-overload-prevent-gain-inc-enable", val);
}
...
{
	return get_u32(dev, "adi,agc-lmt-overload-large-exceed-counter", val);
}
int ad9361_set_agc_lmt_overload_large_exceed_counter (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-lmt-overload-large-exceed-counter", val);
}
...
{
	return get_u32(dev, "adi,agc-lmt-overload-small-exceed-counter", val);
}
int ad9361_set_agc_lmt_overload_small_exceed_counter (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-lmt-overload-small-exceed-counter", val);
}
...
{
	return get_u32(dev, "adi,agc-lmt-overload-large-inc-steps", val);
}
int ad9361_set_agc_lmt_overload_large_inc_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-lmt-overload-large-inc-steps", val);
}
...
{
	return get_u32(dev, "adi,agc-dig-saturation-exceed-counter", val);
}
int ad9361_set_agc_dig_saturation_exceed_counter (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-dig-saturation-exceed-counter", val);
}
...
{
	return get_u32(dev, "adi,agc-dig-gain-step-size", val);
}
int ad9361_set_agc_dig_gain_step_size (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-dig-gain-step-size", val);
}
...
{
	return get_int(dev, "adi,agc-sync-for-gain-counter-enable", val);
}
int ad9361_set_agc_sync_for_gain_counter_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,agc-sync-for-gain-counter-enable", val);
}
...
{
	return get_u32(dev, "adi,agc-gain-update-interval-us", val);
}
int ad9361_set_agc_gain_update_interval_us (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,agc-gain-update-interval-us", val);
}
...
{
	return get_int(dev, "adi,agc-immed-gain-change-if-large-adc-overload-enable", val);
}
int ad9361_set_agc_immed_gain_change_if_large_adc_overload_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,agc-immed-gain-change-if-large-adc-overload-enable", val);
}
...
{
	return get_int(dev, "adi,agc-immed-gain-change-if-large-lmt-overload-enable", val);
}
int ad9361_set_agc_immed_gain_change_if_large_lmt_overload_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,agc-immed-gain-change-if-large-lmt-overload-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-dec-pow-measurement-duration", val);
}
int ad9361_set_fagc_dec_pow_measurement_duration (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-dec-pow-measurement-duration", val);
}
...
{
	return get_u32(dev, "adi,fagc-state-wait-time-ns", val);
}
int ad9361_set_fagc_state_wait_time_ns (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-state-wait-time-ns", val);
}
...
{
	return get_int(dev, "adi,fagc-allow-agc-gain-increase-enable", val);
}
int ad9361_set_fagc_allow_agc_gain_increase_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-allow-agc-gain-increase-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-lp-thresh-increment-time", val);
}
int ad9361_set_fagc_lp_thresh_increment_time (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-lp-thresh-increment-time", val);
}
...
{
	return get_u32(dev, "adi,fagc-lp-thresh-increment-steps", val);
}
int ad9361_set_fagc_lp_thresh_increment_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-lp-thresh-increment-steps", val);
}
...
{
	return get_u32(dev, "adi,fagc-lock-level", val);
}
int ad9361_set_fagc_lock_level (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-lock-level", val);
}
...
{
	return get_int(dev, "adi,fagc-lock-level-lmt-gain-increase-enable", val);
}
int ad9361_set_fagc_lock_level_lmt_gain_increase_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-lock-level-lmt-gain-increase-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-lock-level-gain-increase-upper-limit", val);
}
int ad9361_set_fagc_lock_level_gain_increase_upper_limit (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-lock-level-gain-increase-upper-limit", val);
}
...
{
	return get_u32(dev, "adi,fagc-lpf-final-settling-steps", val);
}
int ad9361_set_fagc_lpf_final_settling_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-lpf-final-settling-steps", val);
}
...
{
	return get_u32(dev, "adi,fagc-lmt-final-settling-steps", val);
}
int ad9361_set_fagc_lmt_final_settling_steps (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-lmt-final-settling-steps", val);
}
...
{
	return get_u32(dev, "adi,fagc-final-overrange-count", val);
}
int ad9361_set_fagc_final_overrange_count (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-final-overrange-count", val);
}
...
{
	return get_int(dev, "adi,fagc-gain-increase-after-gain-lock-enable", val);
}
int ad9361_set_fagc_gain_increase_after_gain_lock_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-gain-increase-after-gain-lock-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-gain-index-type-after-exit-rx-mode", val);
}
int ad9361_set_fagc_gain_index_type_after_exit_rx_mode (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-gain-index-type-after-exit-rx-mode", val);
}
...
{
	return get_int(dev, "adi,fagc-use-last-lock-level-for-set-gain-enable", val);
}
int ad9361_set_fagc_use_last_lock_level_for_set_gain_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-use-last-lock-level-for-set-gain-enable", val);
}
...
{
	return get_int(dev, "adi,fagc-rst-gla-stronger-sig-thresh-exceeded-enable", val);
}
int ad9361_set_fagc_rst_gla_stronger_sig_thresh_exceeded_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-rst-gla-stronger-sig-thresh-exceeded-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-optimized-gain-offset", val);
}
int ad9361_set_fagc_optimized_gain_offset (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-optimized-gain-offset", val);
}
...
{
	return get_u32(dev, "adi,fagc-rst-gla-stronger-sig-thresh-above-ll", val);
}
int ad9361_set_fagc_rst_gla_stronger_sig_thresh_above_ll (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-rst-gla-stronger-sig-thresh-above-ll", val);
}
...
{
	return get_int(dev, "adi,fagc-rst-gla-engergy-lost-sig-thresh-exceeded-enable", val);
}
int ad9361_set_fagc_rst_gla_engergy_lost_sig_thresh_exceeded_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-rst-gla-engergy-lost-sig-thresh-exceeded-enable", val);
}
...
{
	return get_int(dev, "adi,fagc-rst-gla-engergy-lost-goto-optim-gain-enable", val);
}
int ad9361_set_fagc_rst_gla_engergy_lost_goto_optim_gain_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-rst-gla-engergy-lost-goto-optim-gain-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-rst-gla-engergy-lost-sig-thresh-below-ll", val);
}
int ad9361_set_fagc_rst_gla_engergy_lost_sig_thresh_below_ll (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-rst-gla-engergy-lost-sig-thresh-below-ll", val);
}
...
{
	return get_u32(dev, "adi,fagc-energy-lost-stronger-sig-gain-lock-exit-cnt", val);
}
int ad9361_set_fagc_energy_lost_stronger_sig_gain_lock_exit_cnt (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-energy-lost-stronger-sig-gain-lock-exit-cnt", val);
}
...
{
	return get_int(dev, "adi,fagc-rst-gla-large-adc-overload-enable", val);
}
int ad9361_set_fagc_rst_gla_large_adc_overload_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-rst-gla-large-adc-overload-enable", val);
}
...
{
	return get_int(dev, "adi,fagc-rst-gla-large-lmt-overload-enable", val);
}
int ad9361_set_fagc_rst_gla_large_lmt_overload_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-rst-gla-large-lmt-overload-enable", val);
}
...
{
	return get_int(dev, "adi,fagc-rst-gla-en-agc-pulled-high-enable", val);
}
int ad9361_set_fagc_rst_gla_en_agc_pulled_high_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,fagc-rst-gla-en-agc-pulled-high-enable", val);
}
...
{
	return get_u32(dev, "adi,fagc-rst-gla-if-en-agc-pulled-high-mode", val);
}
int ad9361_set_fagc_rst_gla_if_en_agc_pulled_high_mode (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-rst-gla-if-en-agc-pulled-high-mode", val);
}
...
{
	return get_u32(dev, "adi,fagc-power-measurement-duration-in-state5", val);
}
int ad9361_set_fagc_power_measurement_duration_in_state5 (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,fagc-power-measurement-duration-in-state5", val);
}
...
{
	return get_u32(dev, "adi,rssi-restart-mode", val);
}
int ad9361_set_rssi_restart_mode (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rssi-restart-mode", val);
}
...
{
	return get_int(dev, "adi,rssi-unit-is-rx-samples-enable", val);
}
int ad9361_set_rssi_unit_is_rx_samples_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,rssi-unit-is-rx-samples-enable", val);
}
...
{
	return get_u32(dev, "adi,rssi-delay", val);
}
int ad9361_set_rssi_delay (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rssi-delay", val);
}
...
{
	return get_u32(dev, "adi,rssi-wait", val);
}
int ad9361_set_rssi_wait (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rssi-wait", val);
}
...
{
	return get_u32(dev, "adi,rssi-duration", val);
}
int ad9361_set_rssi_duration (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,rssi-duration", val);
}
...
{
	return get_u32(dev, "adi,ctrl-outs-index", val);
}
int ad9361_set_ctrl_outs_index (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,ctrl-outs-index", val);
}
...
{
	return get_u32(dev, "adi,ctrl-outs-enable-mask", val);
}
int ad9361_set_ctrl_outs_enable_mask (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,ctrl-outs-enable-mask", val);
}
...
{
	return get_u32(dev, "adi,elna-settling-delay-ns", val);
}
int ad9361_set_elna_settling_delay_ns (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,elna-settling-delay-ns", val);
}
...
{
	return get_u32(dev, "adi,elna-gain-mdB", val);
}
int ad9361_set_elna_gain_mdB (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,elna-gain-mdB", val);
}
...
{
	return get_u32(dev, "adi,elna-bypass-loss-mdB", val);
}
int ad9361_set_elna_bypass_loss_mdB (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,elna-bypass-loss-mdB", val);
}
...
{
	return get_int(dev, "adi,elna-rx1-gpo0-control-enable", val);
}
int ad9361_set_elna_rx1_gpo0_control_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,elna-rx1-gpo0-control-enable", val);
}
...
{
	return get_int(dev, "adi,elna-rx2-gpo1-control-enable", val);
}
int ad9361_set_elna_rx2_gpo1_control_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,elna-rx2-gpo1-control-enable", val);
}
...
{
	return get_u32(dev, "adi,temp-sense-measurement-interval-ms", val);
}
int ad9361_set_temp_sense_measurement_interval_ms (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,temp-sense-measurement-interval-ms", val);
}
...
{
	return ad9361_sysfs_scanf(dev, ROOT, "adi,temp-sense-offset-signed", "%d", val);
}
int ad9361_set_temp_sense_offset_signed (unsigned dev, int val)
{
	return ad9361_sysfs_printf(dev, ROOT, "adi,temp-sense-offset-signed", "%d", val);
}
...
{
	return get_int(dev, "adi,temp-sense-periodic-measurement-enable", val);
}
int ad9361_set_temp_sense_periodic_measurement_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,temp-sense-periodic-measurement-enable", val);
}
...
{
	return get_u32(dev, "adi,temp-sense-decimation", val);
}
int ad9361_set_temp_sense_decimation (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,temp-sense-decimation", val);
}
...
{
	return get_u32(dev, "adi,aux-adc-rate", val);
}
int ad9361_set_aux_adc_rate (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-adc-rate", val);
}
...
{
	return get_u32(dev, "adi,aux-adc-decimation", val);
}
int ad9361_set_aux_adc_decimation (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-adc-decimation", val);
}
...
{
	return get_int(dev, "adi,aux-dac-manual-mode-enable", val);
}
int ad9361_set_aux_dac_manual_mode_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac-manual-mode-enable", val);
}
...
{
	return get_u32(dev, "adi,aux-dac1-default-value-mV", val);
}
int ad9361_set_aux_dac1_default_value_mV (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-dac1-default-value-mV", val);
}
...
{
	return get_int(dev, "adi,aux-dac1-active-in-rx-enable", val);
}
int ad9361_set_aux_dac1_active_in_rx_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac1-active-in-rx-enable", val);
}
...
{
	return get_int(dev, "adi,aux-dac1-active-in-tx-enable", val);
}
int ad9361_set_aux_dac1_active_in_tx_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac1-active-in-tx-enable", val);
}
...
{
	return get_int(dev, "adi,aux-dac1-active-in-alert-enable", val);
}
int ad9361_set_aux_dac1_active_in_alert_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac1-active-in-alert-enable", val);
}
...
{
	return get_u32(dev, "adi,aux-dac1-rx-delay-us", val);
}
int ad9361_set_aux_dac1_rx_delay_us (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-dac1-rx-delay-us", val);
}
...
{
	return get_u32(dev, "adi,aux-dac1-tx-delay-us", val);
}
int ad9361_set_aux_dac1_tx_delay_us (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-dac1-tx-delay-us", val);
}
...
{
	return get_u32(dev, "adi,aux-dac2-default-value-mV", val);
}
int ad9361_set_aux_dac2_default_value_mV (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-dac2-default-value-mV", val);
}
...
{
	return get_int(dev, "adi,aux-dac2-active-in-rx-enable", val);
}
int ad9361_set_aux_dac2_active_in_rx_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac2-active-in-rx-enable", val);
}
...
{
	return get_int(dev, "adi,aux-dac2-active-in-tx-enable", val);
}
int ad9361_set_aux_dac2_active_in_tx_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac2-active-in-tx-enable", val);
}
...
{
	return get_int(dev, "adi,aux-dac2-active-in-alert-enable", val);
}
int ad9361_set_aux_dac2_active_in_alert_enable (unsigned dev, int val)
{
	return set_int(dev, "adi,aux-dac2-active-in-alert-enable", val);
}
...
{
	return get_u32(dev, "adi,aux-dac2-rx-delay-us", val);
}
int ad9361_set_aux_dac2_rx_delay_us (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-dac2-rx-delay-us", val);
}
...
{
	return get_u32(dev, "adi,aux-dac2-tx-delay-us", val);
}
int ad9361_set_aux_dac2_tx_delay_us (unsigned dev, uint32_t val)
{
	return set_u32(dev, "adi,aux-dac2-tx-delay-us", val);
}
