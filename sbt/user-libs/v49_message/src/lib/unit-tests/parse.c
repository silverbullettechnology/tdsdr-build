...
static uint32_t command_xmas[] = 
{
	...
	0x0000000D, // Timestamp Format: TSF Sample, TSI Other
	0x00010000, // Event Period Specifier: 1 second
	0x28200000, // Coontext Indicator Field: Bandwidth, RF Ref Freq, Sample Rate
};
...
// Packet 4-9: Client configures timestamps
static uint32_t exchange_pkt_09[] =
{
	0x59000008, // Header: Type 5, Stream Identifier, Coarse Timing, 8 words length
	0x000000a0, // Stream Identifier: assigned for stream
	0x00112233, // Class Identifier: SBT OUI 11:22:33
	0x00010001, // Class Identifier: Information Class Code 1, Packet Class Code 1.
	0x0000000A, // Request / Response: Request, Timestamp Control
	0x01800000, // Parameter Indicator: Timestamp Format, Event Period Specifier
	0x00000003, // Timestamp Format: TSI 00(0): No Integer-seconds Timestamp, TSF 11(3): Free-Running Count Timestamp
	0x00004000, // Event Period Specifier: Report every 250ms
};
...
// Packet 4-10: Client success in configuring timestamps
static uint32_t exchange_pkt_10[] =
{
    ...
    0x00112233, // Class Identifier: SBT OUI 11:22:33
    0x00010001, // Class Identifier: Information Class Code 1, Packet Class Code 1.
    0x4000000a, // Request / Response: Result, Timestamp Control, Success
    0x00000000, // Parameter Indicator: none
};
...
// Packet 4-11: Current timestamp report
// Note: The Current timestamp report may be generated by software or by FPGA. Software-generated
// reports will have the “C” (Coarse timing) bit in the header word, while FPGA-generated reports will not.
// If the Agent is using FPGA-generated reports, the software will send a response with no timestamp,
// and also trigger the FPGA to generate a report with a precise timestamp. Subsequent reports will be
// sent by the FPGA. Client software should be prepared to filter multiple timestamp reports and discard
// reports with no timestamp.
static uint32_t exchange_pkt_11[] =
{
    0x58300008, // Header: Type 5, Stream Identifier, Precise Timing, TSF is Sample Count, 8 words length
    0x000000a0, // Stream Identifier: assigned for stream
    0x00112233, // Class Identifier: SBT OUI 11:22:33
    0x00010001, // Class Identifier: Information Class Code 1, Packet Class Code 1.
    0x00000008, // Fractional-seconds Timestamp: 34877915640 samples
    0x1ee2c1f8, // Fractional-seconds Timestamp: 34877915640 samples
    0x4000000a, // Request / Response: Result, Timestamp Control, Success
    0x00000000, // Parameter Indicator: none
};
...
// Packet 4-12: Client requests to stop traffic
...
// Packet 4-13: Client success in setting Stop condition
...
// Packet 4-14: Client requests to start traffic
...
// Packet 4-15: Client success in opening resource
...
// Packet 4-16: Client requests to Close/Suspend resource
...
// Packet 4-17: Close/Suspend success
...
static uint32_t exchange_pkt_17[] =
{
	0x59000006, // Header: Type 5, Stream Identifier, Coarse Timing, 6 words length
	0x000000a0, // Stream Identifier: assigned for stream
	0x00112233, // Class Identifier: SBT OUI 11:22:33
...
struct parse_test  parse_test_exchange_pkt_17 =
{
	.desc = "exchange_pkt_17", .want = V49_OK_COMPLETE,
	.buff = exchange_pkt_17,   .size = sizeof(exchange_pkt_17),
};

// Packet 4-18: Client requests to Release resource
static uint32_t exchange_pkt_18[] =
{
	0x59000006, // Header: Type 5, Stream Identifier, Coarse Timing, 6 words length
	0x000000a0, // Stream Identifier: assigned for stream
	0x00112233, // Class Identifier: SBT OUI 11:22:33
...
struct parse_test  parse_test_exchange_pkt_18 =
{
	.desc = "exchange_pkt_18", .want = V49_OK_COMPLETE,
	.buff = exchange_pkt_18,   .size = sizeof(exchange_pkt_18),
};

// Packet 4-19: Release success
static uint32_t exchange_pkt_19[] =
{
	0x59000006, // Header: Type 5, Stream Identifier, Coarse Timing, 6 words length
	0x000000a0, // Stream Identifier: assigned for stream
	0x00112233, // Class Identifier: SBT OUI 11:22:33
...
struct parse_test  parse_test_exchange_pkt_19 =
{
	.desc = "exchange_pkt_19", .want = V49_OK_COMPLETE,
	.buff = exchange_pkt_19,   .size = sizeof(exchange_pkt_19),
};
...
struct parse_test *parse_test_list[] =
{
	...
	&parse_test_exchange_pkt_17,
	&parse_test_exchange_pkt_18,
	&parse_test_exchange_pkt_19,
	NULL
};
