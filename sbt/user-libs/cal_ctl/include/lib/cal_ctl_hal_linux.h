/** \file      include/lib/cal_ctl_hal_linux.h
 ...
 */
#ifndef _INCLUDE_LIB_CAL_CTL_HAL_LINUX_H_
#define _INCLUDE_LIB_CAL_CTL_HAL_LINUX_H_
...
int  cal_ctl_hal_linux_spidev_txn  (int fd, int len, void *txb, void *rxb, int spd);
int  cal_ctl_hal_linux_spidev_init (int fd);


#endif /* _INCLUDE_LIB_CAL_CTL_HAL_H_ */
