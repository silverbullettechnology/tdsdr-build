# Host Makefile for ASFE_CTL userspace tool
#
...
#
export CONFIG_USER_LIBS_ASFE_CTL_INCLUDES := y
export CONFIG_USER_LIBS_ASFE_CTL_STATIC   := y
export CONFIG_USER_LIBS_ASFE_CTL_READLINE := y
