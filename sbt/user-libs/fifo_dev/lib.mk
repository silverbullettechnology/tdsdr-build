# Shared-library Makefile for FIFO-dev IOCTLs
#
...
CFLAGS += -Wall -Werror -fpic -I$(PETALINUX)/software/user-modules/fifo_dev
CFLAGS += -I$(PETALINUX)/software/user-libs/fifo_dev
...
ifeq ($(CONFIG_USER_LIBS_FIFO_DEV_STATIC),y)
	cp -a $(STAGEDIR)/usr/lib/$(ANAME)  "$(ROMFSDIR)/usr/lib"
endif
ifeq ($(CONFIG_USER_LIBS_FIFO_DEV_INCLUDES),y)
