...
# CONFIG_MTD_NAND_XILINX_PS is not set
...
# CONFIG_XUSBPS_ERRATA_DT654401 is not set
CONFIG_USB_XUSBPS=y
...
# Additional drivers referenced in the new DTS for kernel 3.12
...
# Contiguous memory area pool for large DMA
CONFIG_CMA=y
CONFIG_DMA_CMA=y
CONFIG_CMA_SIZE_MBYTES=20
CONFIG_CMA_SIZE_SEL_MBYTES=y
