...
CONFIG_CMDLINE="console=ttyPS0,115200n8 root=/dev/ram rw mem=512M initrd=0x00800000,16M earlyprintk mtdparts=physmap-flash.0:512K(nor-fsbl),512K(nor-u-boot),5M(nor-linux),9M(nor-user),1M(nor-scratch),-(nor-rootfs)"
...
# CONFIG_MTD_NAND_ZYNQ is not set
...
# CONFIG_SPI_AD9250FMC is not set
...
#
CONFIG_USB_ZYNQ=y
# CONFIG_USB_ZYNQ_ERRATA_DT654401 is not set
...
CONFIG_CF_AXI_ADC=y
# CONFIG_CF_AXI_FFT is not set
# CONFIG_AXIADC_V2 is not set
...
# CONFIG_AD9548 is not set
# CONFIG_AD9517 is not set
