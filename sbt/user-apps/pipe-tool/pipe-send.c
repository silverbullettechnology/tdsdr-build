...
static struct format_options sd_fmt_opts =
{
	...
	.bits     = 16,
	.packet   = sizeof(struct send_packet),
	.head     = offsetof(struct send_packet, data),
	.data     = sizeof(struct send_packet) - offsetof(struct send_packet, data),
	.foot     = 0,
};
...
int main (int argc, char **argv)
{
	...
	for ( idx = 0; idx < opt_npkts; idx++ )
	{
		...
		pkt->hello[0] = 0x00600000;
		pkt->hello[1] = 0x0000dea8;
		pkt++;
	}
